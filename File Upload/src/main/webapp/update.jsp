				...
				<table class="table table-striped"
					...
					<tbody>
						<tr>
						 ...
						 <tr>
                            <td>
                                <label for="file">삭제 할 파일 선택 : </label>
                                <input type="file" id="file" name="file">
                                <br>
                                <% if (bbs.getBbsFileRealName() != null && !bbs.getBbsFileRealName().isEmpty()) { %>
                                    <input type="checkbox" id="updateFile" name="updateFile" value="true">
                                    <label for="updateFile"></label>
                                    기존 파일: <%=bbs.getBbsFileRealName()%>
                                    <input type="hidden" name="fileName" value="<%=bbs.getBbsFileRealName()%>">
                                <% } %>
                            </td>
                        </tr>
						<tr>
